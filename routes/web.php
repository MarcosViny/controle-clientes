...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/cliente/excluir/{id}', [ClienteController::class, 'delete'])->name('cliente.delete');
    Route::delete('/cliente/excluir/{id}', [ClienteController::class, 'destroy'])->name('cliente.destroy');
});
