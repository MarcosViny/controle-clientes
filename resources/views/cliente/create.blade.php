    ...
    <form action="{{ route('cliente.store') }}" method="post">
        ...
        <fieldset class="form-group border p-3">
            ...
            <div class="mb-3">
                ...
                <div>
                    <div class="form-check form-check-inline">
                        <input type="radio" value="M" name="genero" id="genero_m" class="form-check-input" checked>
                        <label for="genero_m" class="form-check-label">Masculino</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input type="radio" value="F" name="genero" id="genero_f" class="form-check-input">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="telefone" id="telefone" class="form-control phone-ddd-mask">
            </div>
        </fieldset>
